...
wget -O .config https://gitlab.com/$id//openwrt/-/raw/master/.config-b
...
UPLOAD() {
mkdir -p ~/UPLOAD && cd ~/src/bin/targets/*/* && *.bin *.ubi ~/UPLOAD/      
...
cd ~/UPLOAD
git init
git remote add origin https://$id:$ss@github.com/$id/releases.git
